...
function NewTab() {
  window.open(
    "https://drive.google.com/file/d/1CP5j0zC-i9chy6neV0Yxryq0eDI3M9Ks/view?usp=share_link",
    "_blank"
  );
}
...
GitHubCalendar(".calendar", "Kamal_preet_kaur");

// or enable responsive functionality:
GitHubCalendar(".calendar", "Kamal_preet_kaur", { responsive: true });
